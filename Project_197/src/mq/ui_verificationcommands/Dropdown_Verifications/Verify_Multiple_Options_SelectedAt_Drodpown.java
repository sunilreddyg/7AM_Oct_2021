...
public class Verify_Multiple_Options_SelectedAt_Drodpown {
	...
	public static void main(String[] args) throws Exception {
		...
		if(flag==true)
		{
			...
			if(Count > 1)
				System.out.println("Testpass, Dropdown allowed multiple selection");
			else
				System.out.println("Testfail, Dropdown is not allowed multiple collection");
		}
		else
		{
