...
public class String_Comparision_Commands {
	...
	public static void main(String[] args) 
	{
		 ...
		 */
		String ExpResult="Account Created";
		String ActResult="account Created";
		
		boolean flag=ExpResult.equals(ActResult);
		 ...
		 */
		boolean flag1=ExpResult.equalsIgnoreCase(ActResult);
		System.out.println("EqualComparision is --> "+flag1);
